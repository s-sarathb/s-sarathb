// Bot API Key
const BOT_TOKEN = "5547425929:AAEVQPjdDFVjBWKX1-Ho9GSuq6VprWgU5Ro";

// Your Telegram USER ID
const USERID = "1962849321";
      ...
      return new Response(
        ...
        }),
        {
          ...
          headers: {
            ...
            "Access-Control-Allow-Origin": "*",
            "Made-By": "https://github.com/s-sarathb",
          },
        }
      );
    } else {
      const sendmessage = await fetch(
        `https://api.telegram.org/bot$5547425929:AAEVQPjdDFVjBWKX1-Ho9GSuq6VprWgU5Ro/sendMessage`,
        {
          body: JSON.stringify({
            chat_id: USERID,
